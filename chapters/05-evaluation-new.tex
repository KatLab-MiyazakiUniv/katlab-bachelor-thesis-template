...
また、表\ref{tb:detailed_evaluation_results_A}に手法Aで作成されたBMP画像分割アプリシステム仕様書の章立ての評価結果を示す。
...
また、表\ref{tb:detailed_evaluation_results_B}に手法Bで作成されたBMP画像分割アプリシステム仕様書の章立ての評価結果を示す。
...
図\ref{fig:C_chapter_structure_of_bmp_app_1}に被験者Bによる手法Cで作成されたBMP画像分割アプリの章立てを示す。
また、表\ref{tb:detailed_evaluation_results_C}に被験者Bによる手法Cで作成されたBMP画像分割アプリシステム仕様書の章立ての評価結果を示す。
...
図\ref{fig:C_chapter_structure_of_bmp_app_2}に被験者Dによる手法Cで作成されたBMP画像分割アプリの章立てを示す。
また、表\ref{tb:detailed_evaluation_results_C2}に被験者Dによる手法Cで作成されたBMP画像分割アプリシステム仕様書の章立ての評価結果を示す。
...
図\ref{fig:C_chapter_structure_of_cloud_contract_system_1}に、被験者Aにより手法Cで作成されたクラウド型電子契約サービスの章立てを示す。
また、表\ref{tb:cloud_detailed_evaluation_results_C}に、被験者Aにより手法Cで作成されたクラウド型電子契約サービスシステム仕様書の章立ての評価結果を示す。
...
図\ref{fig:C_chapter_structure_of_cloud_contract_system_2}に、被験者Cにより手法Cで作成されたクラウド型電子契約サービスの章立てを示す。
また、表\ref{tb:cloud_detailed_evaluation_results_C2}に、被験者Cにより手法Cで作成されたクラウド型電子契約サービスシステム仕様書の章立ての評価結果を示す。
