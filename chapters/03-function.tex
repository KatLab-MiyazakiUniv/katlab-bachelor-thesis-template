...
これは、LLMに対して専門的かつ業務文書向けの出力スタイルを期待することを明確化するためである。
役割付与を行うことで、より専門的な出力結果を得られることが、先行研究や実践的利用から知られている\cite{role_assignment}。
...
\end{enumerate}
さらに、マークダウン形式、番号付きリスト、余計な文章を出力しないことといった具体的なフォーマット指示も含めている。
