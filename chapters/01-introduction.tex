...
先行研究では、作成するドキュメントの章立てはあらかじめ人間が用意することを前提としている。
...
システム仕様書作成の対象となるシステムの特性に合わせた、章立ての自動生成を目的として、システム仕様書章立て生成のためのプロンプトを提案する。
システム仕様書章立て生成プロンプトは、以下の5つの要素で構成する。
\begin{itemize}
  \item 役割付与
  \item ベースの章立て  
  \item 開発するシステム情報
...
また、システム仕様書章立て生成プロンプトには、以下の4つのプロンプトエンジニアリングの技術を適用する。
\begin{itemize}
