...
\newlist{countdown}{enumerate}{1}
\setlist[countdown]{label=\arabic*., start=5}
...
% 提案手法
\input{chapters/03-proposal.tex}

% 適用例
\input{chapters/04-application.tex}

% 評価
% \input{chapters/05-evaluation.tex}
\input{chapters/05-evaluation-new.tex}
